...
class WhisperSTTHandlerArguments:
    ...
    language: Optional[str] = field(
        ...
        metadata={
            ...
            'zh' (chinese), 'ko' (korean), 'ja' (japanese), 'hi' (hindi),
            'ml' (malayalam), 'pa' (punjabi), 'de' (Deutsch), 'ru' (russia),
            'pt' (portuguese), 'ar' (arabic), 'it' (italian), 'id' (indonesian),
            'vi' (vietnamese), 'th' (thai), 'tr' (turkish), 'ms' (malay),
            'bn' (bengali), 'ta' (tamil), 'fa' (persian), or 'None'.
