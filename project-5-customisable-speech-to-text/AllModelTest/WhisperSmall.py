...
class SpeechToTextTranscriber:
    def __init__(self):
        ...
        self.model = WhisperForConditionalGeneration.from_pretrained(model_id, attn_implementation="eager").to(device)
    ...
    def _transcribe_file(self, file_path):
        ...
        try:
            ...
            result = self.pipe(file_path, return_timestamps=True) #task = "trandcribe"
            text = result['text']
