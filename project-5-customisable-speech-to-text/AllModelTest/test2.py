...
class AudioCapture:
    ...
    def save_and_transcribe_audio(self, audio_data, segment_number):
        ...
        self.transcriber.queue_for_transcription(file_name)
...
class SpeechToTextTranscriber:
    def __init__(self):
        ...
        # Queue to ensure audio files are processed one by one
        self.transcription_queue = Queue()
        self.transcription_thread = Thread(target=self._process_queue)
    ...
    def queue_for_transcription(self, file_path):
        """Adds the audio file to the transcription queue."""
        self.transcription_queue.put(file_path)

    def _process_queue(self):
        """Processes the transcription queue sequentially."""
        while True:
    ...
    def wait_for_completion(self):
        ...
        self.transcription_queue.join()  # Wait until the queue is empty
