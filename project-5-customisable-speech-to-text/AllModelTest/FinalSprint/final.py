...
class SpeechToTextTranscriber:
    ...
    #            "no_speech_threshold": 0.6,
            ...
            detected_language_code = self.detect_language_from_audio(file_path)
            ...
            language = self.identify_language_fasttext(text)
    ...
    def detect_language_from_audio(self, file_path):
        ...
        try:
            ...
            audio_language = prediction[3][0]  # This contains the ISO code of the detected language
    ...
    def identify_language_fasttext(self, text):
