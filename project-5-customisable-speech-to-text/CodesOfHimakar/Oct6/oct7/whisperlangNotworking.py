...
class SpeechToTextTranscriber:
    ...
    def transcribe_real_time(self, audio_input):
        ...
        try:
            ...
            self.detect_language_with_whisper(audio_input)
            ...
            logging.info(f"predicted language token by Whisper: {predicted_language_token}")
        ...
        detected_language_list_mms = self.detect_language_from_audio(audio_input) 
        ...
        if detected_language_list_vox[0] and detected_language_list_mms[0] and detected_language_whisper != "en":
    ...
    def detect_language_with_whisper(self, audio_input, top_k = 5):
        ...
        try:
            ...
            lang_token = predicted_ids.sequences[0, 1]
            language_token_scores = lang_token.values[0][1]  # Scores for the first token in the first (and only) sequence
            logging.info(f"predicted language token by Whisper: {language_token_scores}")
