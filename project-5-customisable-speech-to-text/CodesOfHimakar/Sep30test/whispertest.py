...
class AudioProcessor:
    def __init__(self, sample_rate=16000, chunk_size=1024, silence_duration=0.5, silence_threshold=0.01):
        ...
        self.MIN_AUDIO_LENGTH = self.sample_rate * 0.1  # 0.5 seconds
        self.MAX_AUDIO_LENGTH = self.sample_rate * 5  # 30 seconds
        self.SLIDING_WINDOW = self.sample_rate * 0.5  # 2 seconds
